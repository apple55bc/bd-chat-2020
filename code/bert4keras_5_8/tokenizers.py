...
from bert4keras_5_8.snippets import is_string, is_py2
from bert4keras_5_8.snippets import open


def load_vocab(dict_path, encoding='utf-8', simplified=False, startwith=None, max_num=None):
    """从bert的词典文件中读取词典
    """
    token_dict = {}
